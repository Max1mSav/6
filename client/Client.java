...
public class Client {
    ...
    public Client(String host, int port, int reconnectionTimeout, int maxReconnectionAttempts, UserHelper userHelper) {
        this.host = host;
        this.port = port;
    ...
    private boolean processRequestToServer() {
        ...
        do {
            try {
                requestToServer = serverResponse != null ? userHelper.handle(serverResponse.getResponseCode()) :
                        userHelper.handle(null);
